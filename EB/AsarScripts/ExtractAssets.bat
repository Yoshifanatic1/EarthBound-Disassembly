...
:Start
echo Place a headerless EB ROM named %ROMName% in this folder, then type the number representing what version %ROMName% is.
echo 0 = EarthBound (USA)
echo 1 = Mother 2 (Japan)

:Mode
set /p Input1=""
if exist %ROMName% goto :ROMExists

echo You need to place an EB ROM named %ROMName% in this folder before you can extract any assets^^!
goto :Mode
...
:Japan
echo The Japanese version is not supported.
goto :Mode
set UGFXLoc="../Graphics"
set CGFXLoc="../Graphics/Compressed"
set SPCDatLoc="../SPC700"
...
if %PointerSet% equ 18 goto :MoveSPCDat
goto :MoveNothing
