; Note: Put your custom routine/data macros, references to them, and defines in this file from within the EB_InsertIntegratedPatches and EB_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro EB_InsertIntegratedPatches()
...
macro EB_ApplyPatchesPostAssembly()
