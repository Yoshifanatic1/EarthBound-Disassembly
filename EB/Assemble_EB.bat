...
if "%Input1%" equ "EB_U" goto :USA
if "%Input1%" equ "EB_J" goto :Japan
...
:Japan
set ROMVer="(J)"
set ROMNAME="Mother 2"
goto :Assemble

:USA
set ROMVer="(U)"
set ROMNAME="EarthBound"
...
echo Assembling %GAMDID%... this may take a minute.
echo.
